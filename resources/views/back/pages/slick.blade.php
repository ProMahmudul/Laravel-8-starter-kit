@extends('back.layouts.master', ['title' => 'Slick Slider Example', 'sub' => 'Plugin Integration', 'parent' => 'Examples', 'child' => 'plugins'])
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content">
                        <p class="font-size-sm text-muted">
                            This page showcases how easily you can add a plugin’s JS/CSS assets and init it using a
                            OneUI JS helper.
                        </p>
                    </div>
                </div>
